...
import { hexToString, Address, Hex } from "viem";
...
describe("extractData", () => {
  it("should extract and decode the payload correctly", () => {
    ...
    (hexToString as jest.Mock).mockImplementation((payload: any) => {
      return '{"sender_address":"0x1234567890abcdef", "sender_payload":"0xabcdef"}';
    });

    const testPayload: Hex =
      "0x7b2273656e6465725f61646472657373223a22307831323334353637383930616263646566222c202273656e6465725f7061796c6f6164223a223078616263646566227d" as Hex; // Example hex payload
  ...
  it("should throw an error for invalid JSON", () => {
    ...
    const testPayload: Hex = "0x7b226e616d65223a2268656c6c6f227d" as Hex; // Example hex payload
